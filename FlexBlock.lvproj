...
<Project Type="Project" LVVersion="20008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Flex Block" Type="Folder">
			<Item Name="Config" Type="Folder">
				<Item Name="_FlexWorkerBlockConfig.llb" Type="Document" URL="../Block/FlexWorkerBlock/_FlexWorkerBlockConfig.llb"/>
				<Item Name="Configure FlexWorkerBlock.vi" Type="VI" URL="../Block/FlexWorkerBlock/_FlexWorkerBlockConfig.llb/Configure FlexWorkerBlock.vi"/>
				<Item Name="genHelpFlexWorkerBlock.vi" Type="VI" URL="../Block/FlexWorkerBlock/_FlexWorkerBlockConfig.llb/genHelpFlexWorkerBlock.vi"/>
			</Item>
			<Item Name="Source" Type="Folder">
				<Item Name="FlexWorkerBlock Source.vi" Type="VI" URL="../Block/FlexWorkerBlock/FlexWorkerBlockSource.llb/FlexWorkerBlock Source.vi"/>
				<Item Name="FlexWorkerBlockSource.llb" Type="Document" URL="../Block/FlexWorkerBlock/FlexWorkerBlockSource.llb"/>
			</Item>
		</Item>
		<Item Name="Panels" Type="Folder">
			<Item Name="Value Editor Base.lvclass" Type="LVClass" URL="../Block/FlexBlocks/Value Editor Base/Value Editor Base.lvclass"/>
		</Item>
		<Item Name="Providers" Type="Folder">
			<Item Name="GProviders" Type="Folder">
				<Item Name="IlluminatedG_FlexWorkers.ini" Type="Document" URL="../Block/Providers/GProviders/IlluminatedG_FlexWorkers.ini"/>
			</Item>
			<Item Name="icons" Type="Folder">
				<Item Name="FlexWorker16x16.png" Type="Document" URL="../Block/Providers/icons/FlexWorker16x16.png"/>
				<Item Name="FlexWorkerLibrary.png" Type="Document" URL="../Block/Providers/icons/FlexWorkerLibrary.png"/>
			</Item>
			<Item Name="IlluminatedG" Type="Folder">
				<Item Name="Flex" Type="Folder">
					<Item Name="Workers" Type="Folder">
						<Item Name="FlexWorker_Provider.lvlib" Type="Library" URL="../Block/Providers/IlluminatedG/Flex/Workers/FlexWorker_Provider.lvlib"/>
					</Item>
				</Item>
			</Item>
		</Item>
		<Item Name="Templates" Type="Folder">
			<Item Name="Value Editor Template" Type="Folder">
				<Item Name="Value Editor Template.lvclass" Type="LVClass" URL="../Block/FlexBlocks/Value Editor Template/Value Editor Template.lvclass"/>
			</Item>
			<Item Name="Worker Template" Type="Folder">
				<Item Name="Worker Template.lvlib" Type="Library" URL="../Block/FlexBlocks/Worker Template/Worker Template.lvlib"/>
			</Item>
		</Item>
		<Item Name="FlexBlocks.lvlib" Type="Library" URL="../Block/FlexBlocks/FlexBlocks.lvlib"/>
		<Item Name="RefreshButton.ctl" Type="VI" URL="../Block/FlexBlocks/RefreshButton.ctl"/>
		<Item Name="Test Autocomplete.vi" Type="VI" URL="../Block/FlexBlocks/Test Autocomplete.vi"/>
		<Item Name="Test Express.vi" Type="VI" URL="../Block/FlexBlocks/Test Express.vi"/>
		<Item Name="Traverse GObjects with Visitor.vim" Type="VI" URL="../Block/FlexBlocks/Traverse GObjects with Visitor.vim"/>
		<Item Name="Traverse Visitor VI Type.vit" Type="VI" URL="../Block/FlexBlocks/Traverse Visitor VI Type.vit"/>
